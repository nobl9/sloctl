...
# Move 'slo-1' and 'slo-2' to 'new-service' within the same Project.
sloctl move slo slo-1 slo-2 --to-service=new-service

# Move 'slo-1' to 'new-service' within 'my-project'.
sloctl move slo slo-1 -p my-project --to-service=new-service
