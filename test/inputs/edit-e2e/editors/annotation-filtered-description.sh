...
expected_names="edit-annotation"
...
yq -Y -i '
  if type == "array" then
    .[0].spec.description = "Edited by sloctl edit annotation filters e2e"
  else
    .spec.description = "Edited by sloctl edit annotation filters e2e"
  end
' "$1"
